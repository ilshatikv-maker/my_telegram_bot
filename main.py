...
async def handle_web_app_data(message: types.Message):
    try:
        ...
        # ============== ВИЗЫ ==============
            ...
            await message.answer(visas.get(value, f"📄 *{value}*\n\nИнформация о визе скоро появится"), parse_mode='Markdown')
        ...
        # ============== СТРАХОВКИ ==============
            ...
            await message.answer(insurances.get(value, f"🩺 *{value}*\n\nИнформация о страховке скоро появится"), parse_mode='Markdown')
        ...
        # ============== ПОГОДА ==============
            ...
            await message.answer(weather.get(value, f"🌤️ *{value}*\n\nПрогноз погоды скоро появится"), parse_mode='Markdown')
        ...
        # ============== ТРАНСПОРТ ==============
            ...
            await message.answer(transports.get(value, f"🚗 *{value}*\n\nИнформация о транспорте скоро появится"), parse_mode='Markdown')
        ...
        # ============== ОТЕЛИ ==============
            ...
            await message.answer(hotels.get(value, f"🏨 *{value}*\n\nИнформация об отелях скоро появится"), parse_mode='Markdown')
        ...
        # ============== ЕДА ==============
            ...
            await message.answer(foods.get(value, f"🍜 *{value}*\n\nИнформация о кухне скоро появится"), parse_mode='Markdown')
