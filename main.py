...
async def handle_web_app_data(message: types.Message):
    try:
        ...
        if action == 'country':
            ...
            await message.answer(countries.get(value, f"🇺🇳 *{value}*\n\nИнформация скоро появится"),
                                 parse_mode='Markdown')
        ...
        # ============== ВИЗЫ ==============
            ...
            await message.answer(visas.get(value, f"📄 *{value}*\n\nИнформация о визе скоро появится"),
                                 parse_mode='Markdown')
        ...
        # ============== СТРАХОВКИ ==============
            ...
            await message.answer(insurances.get(value, f"🩺 *{value}*\n\nИнформация о страховке скоро появится"),
                                 parse_mode='Markdown')
        ...
        # ============== ПОГОДА ==============
            ...
            await message.answer(weather.get(value, f"🌤️ *{value}*\n\nПрогноз погоды скоро появится"),
                                 parse_mode='Markdown')
        ...
        # ============== ВАЛЮТА ==============
            ...
            await message.answer(currencies.get(value, f"💵 *{value}*\n\nКурс валюты скоро появится"),
                                 parse_mode='Markdown')

        # ============== ТРАНСПОРТ ==============
        elif action == 'transport':
            transports = {
                'avia': '✈️ *АВИАБИЛЕТЫ*\n\n🔍 *Где искать:*\n• Aviasales, Skyscanner, Google Flights\n\n💰 *Примерные цены (туда-обратно):*\n• Москва - Анталья: от 150€\n• Москва - Стамбул: от 120€\n• Москва - Бангкок: от 350€\n• Москва - Париж: от 250€\n• Москва - Рим: от 220€\n\n📆 *Советы:*\n• Лучшие дни для покупки: вторник, среда\n• Покупайте за 2-3 месяца до вылета\n• Используйте режим инкогнито',

                'train': '🚂 *ПОЕЗДА*\n\n🌍 *В Европе:*\n• Interrail/Eurail: 200-500€ на 7 дней\n• ЖД билеты: от 20€ за поездку\n\n🇷🇺 *В России:*\n• Москва - Питер: от 15€ (Сапсан)\n• Москва - Сочи: от 25€\n\n💡 *Советы:*\n• Покупайте заранее (дешевле)\n• Ночные поезда экономят отель\n• В Европе выгоднее Interrail',

                'bus': '🚌 *АВТОБУСЫ*\n\n🌍 *Международные:*\n• FlixBus (Европа): от 5€ за поездку\n• Ecolines (Прибалтика): от 20€\n\n🌏 *В Азии:*\n• VIP автобусы: от 8€ (Таиланд)\n• Ночные автобусы: от 10€\n\n💰 *Цены:*\n• На 30-40% дешевле поездов\n• Киев - Варшава: от 15€',

                'rental': '🚗 *АРЕНДА АВТО*\n\n💰 *Цены в день:*\n• Европа: от 20€\n• Турция: от 15€\n• Таиланд: от 20€\n• США: от 30$\n\n📋 *Нужные документы:*\n• Права (международные желательно)\n• Паспорт\n• Кредитная карта (залог)\n• Возраст от 21 года\n\n⚠️ *Важно:*\n• Фото машины при получении\n• Полная страховка\n• Проверяйте топливо',

                'taxi': '🚕 *ТАКСИ В МИРЕ*\n\n🌍 *Популярные приложения:*\n• Uber (весь мир)\n• Bolt (Европа)\n• Yandex Taxi (Россия, СНГ)\n• Grab (ЮВА)\n• Careem (Ближний Восток)\n\n💰 *Примерные цены:*\n• Москва: от 2€ за посадку\n• Бангкок: от 1€ за км\n• Стамбул: от 0.30€ за км\n\n💡 *Советы:*\n• В Азии лучше приложения, чем такси с улицы\n• Всегда проверяйте маршрут\n• В Африке и Индии торгуйтесь',

                'metro': '🚇 *МЕТРО В МИРЕ*\n\n🇷🇺 *Москва:* 0.70€, красивое, 15 линий\n🇯🇵 *Токио:* от 1.20€, чистое, сложное\n🇫🇷 *Париж:* 1.90€, 16 линий\n🇬🇧 *Лондон:* 2.50£ (~3€), 11 линий\n🇩🇪 *Берлин:* 3€, 10 линий\n🇨🇳 *Пекин:* 0.40€, самое большое\n🇦🇪 *Дубай:* 0.80€, без водителя\n\n💡 *Советы:*\n• Покупайте проездные на день\n• В Европе выгоднее туристические карты\n• Скачайте карту метро офлайн',

                'ferry': '⛴️ *ПАРОМЫ И ВОДНЫЙ ТРАНСПОРТ*\n\n🇬🇷 *Греция:*\n• Между островами: от 15€\n• Афины - Санторини: от 40€\n\n🇮🇹 *Италия:*\n• Венеция: вапоретто 7.50€\n• Неаполь - Капри: от 20€\n\n🇹🇭 *Таиланд:*\n• Острова: от 8€\n• Лонг-тейл: от 2.50€\n\n🇸🇪 *Скандинавия:*\n• Хельсинки - Стокгольм: от 30€',

                'bicycle': '🚲 *ВЕЛОПРОКАТ*\n\n🌍 *В Европе:*\n• Париж (Vélib): 5€/день\n• Амстердам: от 10€/день\n• Берлин: 3€/час\n\n🌏 *В Азии:*\n• Таиланд: от 2.50€/день\n• Вьетнам: от 2€/день\n\n💡 *Советы:*\n• Шлем обязателен не везде\n• Фоткайте велосипед перед арендой\n• Проверяйте тормоза и шины'
            }

            # Если выбрана конкретная опция
            if value in transports:
                await message.answer(transports[value], parse_mode='Markdown')
            else:
                # Показываем общее меню транспорта
                menu = "🚗 *ТРАНСПОРТ В ПУТЕШЕСТВИЯХ*\n\nВыберите вид транспорта:\n\n"
                menu += "✈️ *Авиабилеты* - перелеты\n"
                menu += "🚂 *Поезда* - ж/д билеты\n"
                menu += "🚌 *Автобусы* - междугородние\n"
                menu += "🚗 *Аренда авто* - машины\n"
                menu += "🚕 *Такси* - в разных странах\n"
                menu += "🚇 *Метро* - в мире\n"
                menu += "⛴️ *Паромы* - водный транспорт\n"
                menu += "🚲 *Велопрокат* - велосипеды\n\n"
                menu += "👇 Выберите конкретный пункт в меню"
        ...
        # ============== ОТЕЛИ ==============
            ...
            await message.answer(hotels.get(value, f"🏨 *{value}*\n\nИнформация об отелях скоро появится"),
                                 parse_mode='Markdown')
        ...
        # ============== ЕДА ==============
            ...
            await message.answer(foods.get(value, f"🍜 *{value}*\n\nИнформация о кухне скоро появится"),
                                 parse_mode='Markdown')
